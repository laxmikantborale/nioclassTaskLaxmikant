...
const Question3 = () => {
    ...
    useEffect(() => {
        fetch("https://0h8nti4f08.execute-api.ap-northeast-1.amazonaws.com/getQuestionDetails/getquestiondetails?QuestionID=DifferentialCalculus2_901")
    ...
    return (
        <div className='app'>
                ...
                <MathJaxContext>
                    <MathJax>
                        <div className='question'>
                            <h3>Question 3 :{data[0].Question}</h3>
                        </div>
            ...
            <div className='btns'>
                ...
                <Link to='/question2'><button>2</button></Link>
                <Link to='/question3'><button className='third'>3</button></Link>
            </div>
        </div>
    )
}
