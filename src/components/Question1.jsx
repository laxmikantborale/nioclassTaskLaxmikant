...
const Question1 = () => {
    ...
    useEffect(() => {
        fetch("https://0h8nti4f08.execute-api.ap-northeast-1.amazonaws.com/getQuestionDetails/getquestiondetails?QuestionID=AreaUnderTheCurve_901")
    ...
    return (
        <div className='app'>
                ...
                <MathJaxContext>
                    <MathJax>
                        <div className='question'>
                            <h3>Question 1 :{data[0].Question}</h3>
                        </div>
            ...
            <div className='btns'>
                <Link to='/'><button className='first'>1</button></Link>
